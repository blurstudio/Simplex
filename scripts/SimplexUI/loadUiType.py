...
try:
	...
	from PySide2.QtCore import Signal, QSortFilterProxyModel, Slot
	...
	try:
		...
		from PySide.QtCore import Qt, QObject, QTimer, QPoint, QEvent, QSettings
		...
		from PyQt4.QtCore import Qt, QObject, QTimer, QPoint, QEvent, QSettings
